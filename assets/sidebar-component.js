...
const MENU_TOOLS = [
    ...
    { label: 'Nolvo Sitemap Builder', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/No.svg' },
    { label: 'Qerlo Shortener', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Qe.svg' },
    { label: 'Tivra Minify', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ti.svg' },
    { label: 'Semora Schema Generator', minRole: 'sergeant', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Se.svg' },
    { label: 'Brilo Speed Check', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Br.svg' },
    { label: 'Sorbi Robots Builder', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/So.svg' },
    { label: 'Velto Meta Inspector', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ve.svg' },
    ...
    { label: 'Galvo Video Converter', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ga.svg' },
    { label: 'Xelpo Pass Generator', minRole: 'sergeant', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Xe.svg' },
    { label: 'Dirmo DNS Checker', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Di.svg' },
    { label: 'Lemro Keyword Research', minRole: 'commander', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Le.svg' },
    { label: 'Hirvo Density', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Hi.svg' },
    { label: 'Jorvi Redirect', minRole: 'sergeant', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Jo.svg' },
    { label: 'Mirto CRM', minRole: 'commander', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Mi.svg' },
    { label: 'Ravlo Calendar', minRole: 'commander', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ra.svg' },
    { label: 'Rinvo Accounting', minRole: 'commander', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ri.svg' },
    { label: 'Yelmo Brand Namer', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ye.svg' },
    { label: 'Cedro Flashcards', minRole: 'commander', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ce.svg' },
    { label: 'Fresca Colors Tool', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Fr.svg' },
    { label: 'Ubiro Beer Cost', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ub.svg' },
    { label: 'Refacto Code Beautifier', minRole: 'recruit', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Re.svg' },
    ...
    { label: 'Tavio Prompt Library', minRole: 'commander', link: 'https://arminsilatani.github.io/tavio/', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ta.svg' },
    ...
    { label: 'Valeno Expiry Date Reminder', minRole: 'sergeant', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Va.svg' },
    { label: 'Alviano Recipe Manager', minRole: 'commander', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Al.svg' },
    { label: 'Mavero Workout Tracker', minRole: 'sergeant', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ma.svg' },
    { label: 'Tempozio Time Tracker', minRole: 'commander', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Te.svg' },
