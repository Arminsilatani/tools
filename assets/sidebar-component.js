...
const MENU_TOOLS = [
    { label: 'Codara Service Generator', minRole: 'general', link: 'https://arminsilatani.github.io/codara/', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Co.svg' },
    { label: 'Nolvo Sitemap Builder', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/No.svg' },
    { label: 'Qerlo Shortener', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Qe.svg' },
    { label: 'Tivra Minify', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ti.svg' },
    { label: 'Semora Schema Generator', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Se.svg' },
    { label: 'Brilo Speed Check', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Br.svg' },
    { label: 'Sorbi Robots Builder', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/So.svg' },
    { label: 'Velto Meta Inspector', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ve.svg' },
    { label: 'Zorio Image Converter', minRole: 'recruit', link: 'https://arminsilatani.github.io/zorio/', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Zo.svg' },
    { label: 'Galvo Video Converter', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ga.svg' },
    { label: 'Xelpo Pass Generator', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Xe.svg' },
    { label: 'Dirmo DNS Checker', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Di.svg' },
    { label: 'Lemro Keyword Research', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Le.svg' },
    { label: 'Hirvo Density', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Hi.svg' },
    { label: 'Jorvi Redirect', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Jo.svg' },
    { label: 'Mirto CRM', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Mi.svg' },
    { label: 'Ravlo Calendar', minRole: 'sergeant', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ra.svg' },
    { label: 'Rinvo Accounting', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ri.svg' },
    { label: 'Yelmo Brand Namer', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ye.svg' },
    { label: 'Cedro Flashcards', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ce.svg' },
    { label: 'Fresca Colors Tool', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Fr.svg' },
    { label: 'Ubiro Beer Cost', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ub.svg' },
    { label: 'Refacto Code Beautifier', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Re.svg' },
    { label: 'Pilvo Text Editor', minRole: 'recruit', link: 'https://arminsilatani.github.io/pilvo/', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Pi.svg' },
    { label: 'Tavio Prompt Library', minRole: 'recruit', link: 'https://arminsilatani.github.io/tavio/', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ta.svg' },
    { label: 'Falco Favicon Generator', minRole: 'recruit', link: 'https://arminsilatani.github.io/falco/', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Fa.svg' },
    { label: 'Lume Epoch Converter', minRole: 'recruit', link: 'https://arminsilatani.github.io/lume/', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Lu.svg' },
    { label: 'Valeno Expiry Date Reminder', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Va.svg' },
    { label: 'Alviano Recipe Manager', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Al.svg' },
    { label: 'Mavero Workout Tracker', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Ma.svg' },
    { label: 'Tempozio Time Tracker', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Te.svg' },
    { label: 'Belluno Wishlist', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Be.svg' },
    { label: 'Nuvello Wallpaper App', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Nu.svg' },
    { label: 'Fiora Period Tracker', minRole: 'general', link: '', iconURL: 'https://arminsilatani.github.io/tools/assets/images/logos/Fi.svg' },
];
